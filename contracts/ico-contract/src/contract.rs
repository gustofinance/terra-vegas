...
use crate::state::{Config, DepositInfo, CONFIG, DEPOSITS, TOTAL_DEPOSIT, RECEIVERS};
use crate::utils::{set_revenue_distribution,deduct_tax};
use crate::msg::{
...
use cosmwasm_std::{
    ...
    Response, StdResult, Uint128, WasmMsg, Order, Coin, BankMsg,
};
...
const CONTRACT_NAME: &str = "terra-vegas-ico";
...
pub fn instantiate(
    ...
    set_revenue_distribution(&mut deps, &msg.receivers)?;
...
pub fn admin_withdraw(
    ...
    let denom =cfg.base_denom.clone();

    let receivers_msgs = RECEIVERS
