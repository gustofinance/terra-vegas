...
use terra_vegas::community::{ConfigResponse, ExecuteMsg, InstantiateMsg, MigrateMsg, QueryMsg};
...
pub fn spend(
    ...
    let token_contract = deps.api.addr_humanize(&config.token_contract)?.to_string();
    Ok(Response::new()
