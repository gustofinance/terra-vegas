...
pub fn instantiate(
    ...
    store_config(
        ...
        &Config {
            ...
            token_contract: deps.api.addr_canonicalize(&msg.token_contract)?,
        ...
        _ => {
            ...
            match msg {
                ExecuteMsg::UpdateConfig {
                    ...
                    token_contract,
                    genesis_time,
                } => update_config(deps, owner, token_contract, genesis_time),
...
pub fn query_config(deps: Deps) -> StdResult<ConfigResponse> {
    ...
    let resp = ConfigResponse {
        ...
        token_contract: deps.api.addr_humanize(&state.token_contract)?.to_string(),
